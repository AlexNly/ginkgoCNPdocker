...
# --
setwd(paste('/var/www/html/ginkgo/uploads/', userID, sep=''))
maxPloidy = 6
...
normal2 = normal
#
GC = read.table(paste("/var/www/html/ginkgo/genomes/", genome, "/", pseudoautosomal, "/GC_", bm, sep=""), header=FALSE, sep="\t", as.is=TRUE)
#
bounds = read.table(paste("/var/www/html/ginkgo/genomes/", genome, "/", pseudoautosomal, "/bounds_", bm, sep=""), header=FALSE, sep="\t")
